...
def parse_cl_args():
    ...
    parser.add_argument("-tsc", type=str, default='maxpressure', dest='tsc', help='traffic signal control algorithm, default:maxpressure; options:websters, maxpressure, fixed, dqn'  )
